...
export function indexHtml(c: CourseManifest): string {
...
<html lang="${xmlEscape(c.lang)}">
  <head>
    ...
    <script src="oelt-components.js"></script>
  </head>
  <body>
    ...
    <script type="module" src="oelt-player.js"></script>
  </body>
</html>
`;
}

const PLAYER_JS = `// OELT default player. Boots @oeltkit/runtime against the inlined manifest and
// renders the course. Generated by @oeltkit/cli — do not hand-edit.
const course = window.OELT_MANIFEST;
